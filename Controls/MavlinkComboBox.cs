        ...
        void MavlinkComboBox_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (_source != null)
            {
                try
                {
                    ...
                    if (!AUV_GCS.MainForm.comPort.setParam(ParamName, (float) (Int32) Enum.Parse(_source, this.Text)))
                    {
                    ...
                    {
                        if (
                            !AUV_GCS.MainForm.comPort.setParam(paramname2,
            ...
            else if (_source2 != null)
            {
                try
                {
                    ...
                    if (!AUV_GCS.MainForm.comPort.setParam(ParamName, (float) (int) ((MavlinkComboBox) sender).SelectedValue))
                    {
