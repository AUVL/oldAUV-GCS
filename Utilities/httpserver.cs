...
/////////////////////////////////////////////////////////////////
                    if (url.Contains("websocket"))
                    {
                        using (var writer = new StreamWriter(stream, Encoding.Default))
                        {
                            ...
                            while (client.Connected)
                            {
                                ...
                                string sendme = MainForm.comPort.MAV.cs.roll + "," + MainForm.comPort.MAV.cs.pitch + "," + MainForm.comPort.MAV.cs.yaw
                                                + "," + MainForm.comPort.MAV.cs.lat + "," + MainForm.comPort.MAV.cs.lng + "," + MainForm.comPort.MAV.cs.alt;
                    ...
                    else if (url.Contains("location.kml"))
                    {
                        ...
                        pmplane.Name = "P/Q " + MainForm.comPort.MAV.cs.altasl;

                        pmplane.Visibility = true;

                        SharpKml.Dom.Location loc = new SharpKml.Dom.Location();
                        loc.Latitude = MainForm.comPort.MAV.cs.lat;
                        loc.Longitude = MainForm.comPort.MAV.cs.lng;
                        loc.Altitude = MainForm.comPort.MAV.cs.altasl;

                        if (loc.Altitude < 0)
                            loc.Altitude = 0.01;

                        SharpKml.Dom.Orientation ori = new SharpKml.Dom.Orientation();
                        ori.Heading = MainForm.comPort.MAV.cs.yaw;
                        ori.Roll = -MainForm.comPort.MAV.cs.roll;
                        ori.Tilt = -MainForm.comPort.MAV.cs.pitch;
                        ...
                        SharpKml.Dom.LookAt la = new SharpKml.Dom.LookAt()
                        {
                            ...
                            Tilt = 80,
                            Heading = MainForm.comPort.MAV.cs.yaw,
     ...
     string header =
                    ...
                    else if (url.Contains("wps.kml"))
                    {
                        ...
                        //else
                        {
                            ...
                            try
                            {
                                foreach (var point in AUV_GCS.GCSViews.MainMap.instance.fullpointlist)
                                {
                             ...
                             url.ToLower().Contains("both.jpg"))
                    {
                        ...
                        while (client.Connected)
                        {
                            ...
                            {
                                /*CSViews.FlightData.myhud.streamjpgenable = true;
                    ...
                    else if (url.Contains("/guided?"))
                    {
                        ...
                        if (match.Success)
                        {
                            ...
                            try
                            {
                                MainForm.comPort.setGuidedModeWP(gwp);
                            }
                            catch
                            {
                            }
        ...
        "NAV_CONTROLLER_OUTPUT": {"msg": {"wp_dist": 0, "nav_pitch": 0.0, "target_bearing": 0, "nav_roll": 0.0, "aspd_error": 0.0, "alt_error": 0.0, "mavpackettype": "NAV_CONTROLLER_OUTPUT", "xtrack_error": 0.0, "nav_bearing": 0}, "index": 687, "time_usec": 0}}
                      */
                        ...
                        if (MainForm.comPort.MAV.getPacket((byte) MAVLink.MAVLINK_MSG_ID.ATTITUDE) != null)
                            message.ATTITUDE = new Message2()
                            {
                                index = 1,
                                msg =
                                    MainForm.comPort.MAV.getPacket((byte)MAVLink.MAVLINK_MSG_ID.ATTITUDE)
                                        .ToStructure<MAVLink.mavlink_attitude_t>()
                            };
                        if (MainForm.comPort.MAV.getPacket((byte)MAVLink.MAVLINK_MSG_ID.VFR_HUD) != null)
                            message.VFR_HUD = new Message2()
                            {
                                index = 1,
                                msg =
                                    MainForm.comPort.MAV.getPacket((byte)MAVLink.MAVLINK_MSG_ID.VFR_HUD)
                                        .ToStructure<MAVLink.mavlink_vfr_hud_t>()
                            };
                        if (MainForm.comPort.MAV.getPacket((byte)MAVLink.MAVLINK_MSG_ID.NAV_CONTROLLER_OUTPUT) != null)
                            message.NAV_CONTROLLER_OUTPUT = new Message2()
                            {
                                index = 1,
                                msg =
                                    MainForm.comPort.MAV.getPacket((byte)MAVLink.MAVLINK_MSG_ID.NAV_CONTROLLER_OUTPUT)
                                        .ToStructure<MAVLink.mavlink_nav_controller_output_t>()
                            };
                        if (MainForm.comPort.MAV.getPacket((byte)MAVLink.MAVLINK_MSG_ID.GPS_RAW_INT) != null)
                            message.GPS_RAW_INT = new Message2()
                            {
                                index = 1,
                                msg =
                                    MainForm.comPort.MAV.getPacket((byte)MAVLink.MAVLINK_MSG_ID.GPS_RAW_INT)
                                        .ToStructure<MAVLink.mavlink_gps_raw_int_t>()
                            };
                        if (MainForm.comPort.MAV.getPacket((byte) MAVLink.MAVLINK_MSG_ID.HEARTBEAT) != null)
                            message.HEARTBEAT = new Message2()
                            {
                                index = 1,
                                msg =
                                    MainForm.comPort.MAV.getPacket((byte) MAVLink.MAVLINK_MSG_ID.HEARTBEAT)
                                        .ToStructure<MAVLink.mavlink_heartbeat_t>()
                            };
                        if (MainForm.comPort.MAV.getPacket((byte) MAVLink.MAVLINK_MSG_ID.GPS_STATUS) != null)
                            message.GPS_STATUS = new Message2()
                            {
                                index = 1,
                                msg =
                                    MainForm.comPort.MAV.getPacket((byte) MAVLink.MAVLINK_MSG_ID.GPS_STATUS)
                                        .ToStructure<MAVLink.mavlink_gps_status_t>()
                            };
                        if (MainForm.comPort.MAV.getPacket((byte) MAVLink.MAVLINK_MSG_ID.STATUSTEXT) != null)
                            message.STATUSTEXT = new Message2()
                            {
                                index = 1,
                                msg =
                                    MainForm.comPort.MAV.getPacket((byte) MAVLink.MAVLINK_MSG_ID.STATUSTEXT)
                                        .ToStructure<MAVLink.mavlink_statustext_t>()
                            };
                        if (MainForm.comPort.MAV.getPacket((byte) MAVLink.MAVLINK_MSG_ID.SYS_STATUS) != null)
                            message.SYS_STATUS = new Message2()
                            {
                                index = 1,
                                msg =
                                    MainForm.comPort.MAV.getPacket((byte)MAVLink.MAVLINK_MSG_ID.SYS_STATUS)
                            ...
                            message.SYS_STATUS =
                                new Message2()
                                {
                                    ...
                                    msg =
                                        ...
                                        {
                                            master_in = (int)MainForm.comPort.MAV.packetsnotlost,
                                            mavpackettype = "META_LINKQUALITY",
                                            master_out = MainForm.comPort.packetcount,
                                            packet_loss = 100 - MainForm.comPort.MAV.cs.linkqualitygcs,
                                            mav_loss = 0
                                        }
                                };
...
";
        ...
        void refreshmap()
        {
            MethodInvoker m = delegate() { AUV_GCS.GCSViews.MainMap.mymap.Refresh(); };
            MainForm.instance.Invoke(m);
        }
