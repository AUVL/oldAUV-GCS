...
> <Grid>";
        ...
        private static void ApplyCustomTheme(Control temp, int level)
        {
            ...
            foreach (Control ctl in temp.Controls)
            {
                ...
                else if (ctl.GetType() == typeof (RichTextBox))
                {
                    ...
                    if ((ctl.Name == "TXT_terminal")/* && !Mavlinkform.Form1.TerminalTheming*/)
                    {
        ...
        private static void SetBurntKermitColors()
        {
           ...
           /* if (Mavlinkform.Form1.instance != null && Mavlinkform.Form1.instance.FlightPlanner != null)
            {
                BSE.Windows.Forms.Panel actionPanel = Mavlinkform.Form1.instance.FlightPlanner.panelAction;
                BSE.Windows.Forms.Panel waypointsPanel = Mavlinkform.Form1.instance.FlightPlanner.panelWaypoints;
            ...
            if (Mavlinkform.Form1.instance != null)
            {
                Mavlinkform.Form1.instance.switchicons(new Mavlinkform.Form1.burntkermitmenuicons());
            }

            Mavlinkform.Form1.TerminalTheming = true;
