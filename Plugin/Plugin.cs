...
namespace MissionPlanner.Plugin
{
    ...
    public class PluginHost
    {
        ...
        /// Device change event
        /// </summary>
        public event MainForm.WMDeviceChangeEventHandler DeviceChanged;

        internal void ProcessDeviceChanged(MainForm.WM_DEVICECHANGE_enum dc)
        {
        ...
        {
            get { return MainForm.comPort.MAV.cs; }
        }
        ...
        {
            get { return MainForm.instance.FlightData.contextMenuStripMap; }
        }*/
        ...
        {
            get { return MainForm.instance.FlightData.MouseDownStart; }
        }*/
       ...
       /* public GMapProvider FDMapType
        ...
        {
            get { return MainForm.instance.FlightData.contextMenuStripHud; }
        }*/
       ...
       /* public ContextMenuStrip FPMenuMap
        {
            get { return MainForm.instance.MainMap.contextMenuStrip1; }
        }*/
        ...
        {
            get { return MainForm.instance.MainMap.MouseDownEnd; }
        }
        ...
        public GMapPolygon FPDrawnPolygon
        {
            get
            {
                return new GMapPolygon(new List<PointLatLng>(MainForm.instance.MainMap.drawnpolygon.Points),
                    "Poly Copy") {Stroke = MainForm.instance.MainMap.drawnpolygon.Stroke};
            }
        }

        public void RedrawFPPolygon(List<PointLatLngAlt> list)
        {
            MainForm.instance.MainMap.redrawPolygonSurvey(list);
        }
        ...
        {
            get { return MainForm.instance.MainMap.gMapControl1; }
        }
        ...
        {
            get { return MainForm.instance.FlightData.gMapControl1; }
        }*/
        ...
        {
            return MainForm.instance.FlightPlanner.AddCommand(cmd, p1, p2, p3, p4, x, y, z, tag);
        }*/
        ...
        /*public void InsertWP(int idx, MAVLink.MAV_CMD cmd, double p1, double p2, double p3, double p4, double x,
            ...
            double z, object tag = null)
        {
            MainForm.instance.FlightPlanner.InsertCommand(idx, cmd, p1, p2, p3, p4, x, y, z);
        }*/
        ...
        /*public void GetWPs()
        {
            MainForm.instance.FlightPlanner.BUT_read_Click(null, null);
        }*/
    }
}